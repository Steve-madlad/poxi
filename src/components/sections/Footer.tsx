  ...
  return (
    <footer className="bg-black py-10 text-center text-sm text-[#bcbcbc]">
      <div className="main-container px-5">
        <div className="relative inline-flex before:absolute before:top-2 before:bottom-0 before:w-full before:bg-[linear-gradient(to_right,#F87BFF,#fb92cf,#ffdd9b,#c2f0b1,#2fd8fe)] before:blur before:content-['']">
